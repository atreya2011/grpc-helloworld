...
// Source: github.com/atreya2011/grpc-helloworld/helloworld (interfaces: GreeterClient)
...
import (
	context "context"
	helloworld "github.com/atreya2011/grpc-helloworld/helloworld"
...
func (m *MockGreeterClient) SayHello(arg0 context.Context, arg1 *helloworld.HelloRequest, arg2 ...grpc.CallOption) (*helloworld.HelloResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*helloworld.HelloResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
